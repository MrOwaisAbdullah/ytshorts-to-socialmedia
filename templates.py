...
4. Start with a one-liner hook to grab attention.
5. Make the post scannable by:
   - Using short lines (max 3 lines per paragraph)
   - Adding white spaces after each line
   - Using simple English words
   - Using numbers or arrows for readability
6. Do not use too many emojis.
7. Keep the post between 700-1000 characters.
8. Include a Call-to-Action (CTA) with questions or prompts to encourage comments and shares.
9. Do not include any introductory text or explanations; only output the rewritten post. Return only the final post text, without any analysis, process details, or extra text like "Here's the post"
...
Rules to follow:
1. Start with a one-liner hook to grab attention.
2. Use storytelling (90% of the post) to share a journey, mistake, or lesson.
3. Make the post scannable by:
   - Using short lines (max 3 lines per paragraph)
   - Adding white spaces after each line
   - Using simple English words
   - Using numbers or arrows for readability
4. Do not use too many emojis.
5. Keep the post between 700-1000 characters.
6. Do not include hashtags or external links.
7. Include a Call-to-Action (CTA) with questions or prompts to encourage comments and shares.
8. Target audience: People interested in AI, business, and self-improvement.
9. Focus on providing value, not selling.

If needed, assume details from the transcript to make the post personal and relatable.
...
Template #1: "My Journey" Template
Description: Share a personal story. Start with a hook about a challenge or mistake, then explain what happened and what you learned. End with a CTA.

Example:
I thought I had to be perfect to grow on LinkedIn. 
For weeks, I obsessed over every word in my posts. 
I’d write, rewrite, and edit until it felt flawless. 
My first ‘perfect’ post? A list of productivity tips. 
It took me three hours to craft—pure gold, I thought. 
But after I hit publish, it was crickets. Zero likes. 
I felt crushed—like I’d wasted all that time. 
Then, one rainy Thursday, I was done pretending. 
I wrote about a project I’d botched at work. 
The client hated it, my boss was frustrated, and I felt like a failure. 
I shared how I stayed late, redid it from scratch, and owned my mistake. 
I hit post, expecting nothing. 
To my shock, comments flooded in. 
People related—they’d failed too. 
Some thanked me for showing the messy side of work. 
That’s when it clicked: perfection doesn’t connect, authenticity does. 
Now, I share the real stuff—the wins and the flops. 
What’s a time you dropped the perfection mask? Tell me below!

---

Template #2: "Lessons Learned" Template
Description: List lessons from an experience. Start with a hook teasing a lesson, then share them simply with some context. End with a CTA.

Example:
One project taught me three things I’ll never forget. 
It was my first big solo gig—a website redesign for a small business. 
I was so excited to prove myself. 
I mocked up designs, picked fancy fonts, and added every bell and whistle. 
I thought, “This is going to blow them away.” 
But when I showed the client, their face fell. 
They didn’t get it—it was too much, too confusing. 
I’d messed up, and I had to start over. 
Here’s what I learned the hard way:
1. Keep it simple: I’d overloaded the site with features nobody needed. 
   Less is more when it’s clear and usable. 
2. Share, don’t sell: I’d bragged about my ideas instead of asking what they wanted. 
   People care about their story, not mine. 
3. Listen to feedback: I’d brushed off their early hints to simplify. 
   If I’d listened, I’d have saved weeks of rework. 
Now, I design with those lessons in mind every time. 
What’s a lesson you learned after a stumble? Share it!

---

Template #3: "Behind the Scenes" Template
Description: Show your process. Start with a curiosity hook, then explain it simply with some detail. End with a CTA.

Example:
Want to know how I write posts that get 100,000 views? 
It’s not luck or some secret sauce—it’s a process I’ve honed for years. 
Back when I started, my posts flopped hard. 
I’d ramble, overthink, and get maybe five likes from friends. 
Then I studied what worked and built this system:
1. Start with a story: I dig into my life for something real. 
   Last week, I wrote about spilling coffee on my laptop before a big meeting. 
   It’s relatable—it hooks people in. 
2. Add tools: I use AI like ChatGPT to brainstorm drafts. 
   I’ll type a rough idea, and it spits out options I can tweak. 
   Then I mix in my voice so it’s not robotic. 
3. Edit a lot: I slash anything boring or wordy. 
   I add punchy hooks, break lines for easy reading, and test it on a friend. 
   It’s like sculpting—chip away until it shines. 
This took months of trial and error to get right. 
Now, it’s my go-to, and the views prove it works. 
What’s your process for creating something great? Let’s swap ideas!
...
prompt_carousel = """
You are an expert in creating engaging carousel posts for LinkedIn.

Your task is to transform the provided [content] and [context] into a carousel post that includes a caption and 5-7 slides.

Rules:
1. The caption should be 2-3 engaging sentences with a clear call-to-action.
2. Each slide must have a title (under 60 characters) and 3 concise bullet points.
3. Use simple, relatable language and format the content for easy scanning (short lines, ample white space).
4. Focus on storytelling by sharing your personal journey, struggles, or key lessons.
5. Do not include hashtags or external links.
6. Use the following sample templates for inspiration:
{sample_templates}
...
Template #1: "My Journey" Template:
- Caption: Share a brief personal story.
- Slides: Each slide includes a title and 3 bullet points detailing a challenge and lesson.
- End with a call-to-action.

Template #2: "Step-by-Step" Template:
- Caption: Introduce a process or method.
- Slides: List 5 steps, each with a concise title and description.
- End with a question inviting feedback.
"""


# X Threads and Tweets Template

tweet_reviewer_prompt = """
Rewrite the following tweet following these rules:
1. Use very simple English that even non-natives can understand easily.
2. If a concept is unclear, expand it concisely.
3. Do not use any of the following phrases or words:
revolutionize
dive in
venture
innovative
...
5. Start with a one-liner hook to grab attention.
6. Make the tweet scannable:
   - Use short sentences (max 2 lines per tweet).
   - Add white space for clarity.
7. Do not use too many emojis.
8. Include a Call-to-Action (CTA) with a question or prompt to encourage engagement.
9. Do not include any introductory text or explanations; only output the rewritten tweet.
...
thread_reviewer_prompt = """
Rewrite the following Twitter thread following these rules:
1. Use very simple English that even non-natives can understand easily.
2. If a concept is unclear, expand it concisely.
3. Do not use any of the following phrases or words:
revolutionize
...
4. Keep each tweet in the thread under 280 characters.
5. Start the first tweet with a strong hook to grab attention.
6. Ensure each tweet flows smoothly into the next.
7. Do not add numbering, labels, or "Thread" at the beginning.
8. Make the thread scannable:
   - Use short sentences (max 2 lines per tweet).
   - Add white space for clarity.
9. Include a Call-to-Action (CTA) and closure in the final tweet.
10. Separate multiple tweets using the delimiter "|||".
11. Do not include any introductory text or explanations; only output the rewritten thread.
...
tweet_template_1 = """
Template #1: Quick Insight
- Hook: Start with "Did you know?" or "Fun fact:"
- Present a surprising or interesting piece of information in one sentence.
- Make a concise statement of a key idea or fact.
- End with a short call-to-action like "What do you think?" or "Share your thoughts!"
"""

tweet_template_2 = """
Template #2: Personal Anecdote
- Hook: Begin with "I remember when..." or "It all started with..."
- Briefly share a personal moment or lesson in 1-2 short sentences.
- End with a question such as "Have you experienced this?" or "What’s your story?"
"""

tweet_template_3 = """
Template #3: Tip of the Day
- Hook: Start with "Tip:" or "Here's a tip:"
- Provide one actionable piece of advice in a single sentence.
- End with a call-to-action like "Try it out!" or "Let me know if it works!"
"""

tweet_template_4 = """
Template #4: Provocative Question
- Hook: Begin with "Ever wondered why..." or "Why do you think..."
- Present a surprising fact or observation in one concise sentence.
- End with a prompt such as "Drop your thoughts below!" or "What's your take?"
"""

tweet_template_5 = """
Template #5: "Mini Story" Template:
...
prompt_tweet = """
You are an expert in crafting engaging tweets.

Your task is to analyze the provided [content] and [context].

Rules:
1. Each tweet must be under 280 characters.
2. Start with a catchy one-liner hook.
3. Use simple, relatable language with a touch of storytelling.
4. Do not include any numbers, labels, or enumeration (e.g., "1.", "Thread No.", etc.).
5. Include a call-to-action to encourage engagement.
6. Generate only ONE tweet, not multiple tweets or a thread.
...
prompt_thread = """
You are an expert in crafting compelling Twitter threads.

Your task is to transform the provided [content] and [context]  into a Twitter thread composed of EXACTLY {num_tweets} tweets, separated by "|||".

Rules:
1. The first tweet must start with a strong hook and be under 280 characters.
2. Each tweet must be concise (under 280 characters) and maintain a logical narrative.
3. Use simple language and break up the content into short, digestible lines.
4. Emphasize storytelling by sharing personal experiences, lessons learned, or challenges overcome.
5. Do not include any numbering, labels, or enumerations (e.g., "1.", "Thread No.", etc.).
6. End the thread with a call-to-action to invite responses.
7. Separate each tweet with "|||" and ensure EXACTLY {num_tweets} tweets are generated.
8. Use the following sample templates for inspiration:
{sample_templates}
...
sample_templates_thread = """
Template #1: "My Journey in Brief" Template:
- Hook: Start with a bold statement.
- Share a personal challenge.
- Describe your turning point.
- End with a question to engage your audience.

Template #2: "Lessons Learned" Template:
- Start with a quick hook.
- List 3-4 key lessons.
- End with a call-to-action asking for others' experiences.
"""


# Carousel Templates

carousel_reviewer_prompt = """
Rewrite the following LinkedIn carousel JSON.
Output as JSON with this structure:
{
    "caption": "3-5 engaging sentences with emojis and hashtags",
    "slides": [
        {"title": "Slide title < 60 chars", "points": ["Point 1", "Point 2", "Point 3"]},
        ...
    ]
}

to improve its quality according to these rules:
1. Use very simple English that even non-natives can understand easily.
2. If a concept is unclear, explain it briefly in the points.
3. Avoid complex or forbidden phrases (e.g., revolutionize, innovative, dive in).
4. Ensure the caption is 3-5 engaging sentences with emojis and hashtags.
5. Each slide title must be under 60 characters.
6. Each slide must have exactly 3 concise bullet points.
7. Keep the total slides between 5 and 7.
8. Do not include introductory text or explanations; output only the refined JSON.
...
Transform this [content] into a JSON object with this EXACT structure:
{
    "caption": "engaging sentences with emojis and hashtags",
    "slides": [
        {"title": "Slide title < 60 chars", "points": ["Point 1", "Point 2", "Point 3"]},
        ...
    ]
...
sample_templates_carousel = """
Template #1: "From Struggle to Success"
- Caption: A short, punchy story with emojis and hashtags.
- Slides:
  - Slide 1: "The Problem" - What went wrong at first?
  - Slide 2: "My Aha Moment" - What sparked a change?
  - Slide 3: "The Fix" - How did I solve it?
  - Slide 4: "The Win" - What was the result?
  - Slide 5: "Your Turn" - Ask for audience input.

Template #2: "Quick Lessons That Stick"
- Caption: Highlight key takeaways with flair and hashtags.
- Slides:
  - Slide 1: "Lesson 1" - One big takeaway.
  - Slide 2: "Lesson 2" - Another key point.
  - Slide 3: "Lesson 3" - A third insight.
  - Slide 4: "Why It Matters" - Why these help.
  - Slide 5: "What’s Yours?" - Prompt for comments.

Template #3: "Behind the Scenes Peek"
- Caption: Tease a process with emojis and hashtags.
- Slides:
  - Slide 1: "The Start" - Where it began.
  - Slide 2: "The Work" - What I did daily.
  - Slide 3: "The Hiccup" - A challenge faced.
  - Slide 4: "The Finish" - How it came together.
  - Slide 5: "Your Thoughts?" - Ask for feedback.

Template #4: "Why This Matters"
- Caption: Pose a bold question with emojis and hashtags.
- Slides:
  - Slide 1: "The Big Why" - Why this is important.
  - Slide 2: "Real Impact" - How it affects people.
  - Slide 3: "My Story" - A personal angle.
  - Slide 4: "Next Steps" - What’s coming up.
  - Slide 5: "Join In!" - Engage the audience.

Template #5: "Hack Your Way Forward"
- Caption: Share tips with energy and hashtags.
- Slides:
  - Slide 1: "Hack #1" - A quick tip.
  - Slide 2: "Hack #2" - Another useful trick.
  - Slide 3: "Hack #3" - A third hack.
  - Slide 4: "Try It Out" - How to apply them.
  - Slide 5: "Got One?" - Ask for reader hacks.
"""